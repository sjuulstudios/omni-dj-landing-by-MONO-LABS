...
> **MEEST RECENT (2026-06-09, sessie 80+81):** `main` staat op `6facf52` (origin/main, GEPUSHT). Bevat: sessies 77-80 (`ebfbb5f`), B3 Electron-signing (`3bfb0f9`+`4731c8e`), de 1:1/4:5 export-crop-fix (`f5237a6`). De gesignde + genotariseerde DMG met die fix staat LIVE op R2: `https://downloads.omnidj.com/Omni-DJ-1.0.0.dmg` (367.542.120 bytes). ENIGE open punt: smoke-test van de live DMG door Sjuul. Zie het sessie-81-blok hieronder. Daarna nog op de roadmap: C6 Calendar-redesign, test-infra (pytest + Playwright op de Mac), per-clip inmix-controls, B4 Windows.
