...
- **TE COMMITTEN sessie 81:** `Omni DJ/app.py`, `HANDOVER.md`. NIET committen: `app.py.pre-sessie81-1x1fix.bak`, `Omni DJ/_verify_1x1_fix.sh`. Hierna: gesignde B3-rebuild zodat de DMG de fix bevat -> smoke-test Sjuul -> DMG->R2.
