...
4. Description: `Landing page for Omni DJ`
...
cd "/Users/sjuulsmits/Documents/Claude/Projects/Omni DJ/landing"
...
### Stap 4 - Custom domain `omnidj.com` koppelen

1. In het Vercel-project → **Settings** → **Domains**
2. Type `omnidj.com` → **Add**
3. Vercel toont nu een DNS-record (meestal A record `76.76.21.21` of CNAME)
4. Voeg óók `www.omnidj.com` toe (Vercel laat dit automatisch redirecten naar root)
5. Ga naar TransIP → **Domeinnaam** → klik `omnidj.com` → tab **DNS-instellingen**
...
2. New Form → Form name `Omni DJ early access`
3. Kopieer de endpoint URL (bv. `https://formspree.io/f/abcd1234`)
4. In `index.html`, vervang `REPLACE_ME` met de form-ID
5. Test door zelf je email in te vullen - komt binnen op omnidj@monohq-labs.com
...
4. Custom domains → `omnidj.com` → volg NS-instructies in TransIP
